...
@Component({
  ...
  templateUrl: './expiryexcahnge-pending.component.html',
  styleUrl: './expiryexcahnge-pending.component.css'
})
export class ExpiryexcahngePendingComponent {
...
displayedColumns: string[] = ['drugName', 'drugCode', 'batchNumber', 'expiryDate', 'perStripPrice', 'stock', 'price', 'shopName', 'contact'];
  ...
  getDrugsByContactNumberAndStatus(): void {
    this.expiryCancleService.finduserpending(this.userId).subscribe(
