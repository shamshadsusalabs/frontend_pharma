...
@Component({
  selector: 'app-brand-pending-order',
  standalone: true,
  imports: [ MatTableModule,
    ...
    MatIconModule,
    RouterLink],
  templateUrl: './brand-pending-order.component.html',
  styleUrl: './brand-pending-order.component.css'
})
export class BrandPendingOrderComponent {
