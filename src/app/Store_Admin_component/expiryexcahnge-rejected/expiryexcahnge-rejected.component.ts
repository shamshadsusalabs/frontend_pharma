...
@Component({
  ...
  templateUrl: './expiryexcahnge-rejected.component.html',
  styleUrl: './expiryexcahnge-rejected.component.css'
})
export class ExpiryexcahngeRejectedComponent {
...
displayedColumns: string[] = ['drugName', 'drugCode', 'batchNumber', 'expiryDate', 'perStripPrice', 'stock', 'price', 'shopName', 'contact'];
  ...
  getDrugsByContactNumberAndStatus(): void {
    this.expiryCancleService.finduserRejected(this.userId).subscribe(
