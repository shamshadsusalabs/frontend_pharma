...
@Component({
  selector: 'app-brand-confirm-order',
  standalone: true,
  imports: [MatTableModule,
    ...
    MatButtonModule,
    MatIconModule,],
  templateUrl: './brand-confirm-order.component.html',
  styleUrl: './brand-confirm-order.component.css'
})
export class BrandConfirmOrderComponent {
