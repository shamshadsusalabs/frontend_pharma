...
@Component({
  selector: 'app-distributor-set-shopanddiscount',
  standalone: true,
  imports: [
    ReactiveFormsModule,
    MatFormFieldModule,
  ...
  templateUrl: './distributor-set-shopanddiscount.component.html',
  styleUrl: './distributor-set-shopanddiscount.component.css'
})
export class DistributorSetShopanddiscountComponent {
