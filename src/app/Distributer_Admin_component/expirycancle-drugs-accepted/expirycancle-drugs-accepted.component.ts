...
@Component({
  ...
  templateUrl: './expirycancle-drugs-accepted.component.html',
  styleUrl: './expirycancle-drugs-accepted.component.css'
})
export class ExpirycancleDrugsAcceptedComponent {
 displayedColumns: string[] = ['drugName', 'drugCode', 'batchNumber', 'expiryDate', 'perStripPrice', 'stock', 'price', 'shopName', 'contact', 'action'];
  ...
  getDrugsByContactNumberAndStatus(): void {
    this.expiryCancleService.findDrugsByContactNumberAndAccepted(this.contactNumber).subscribe(
