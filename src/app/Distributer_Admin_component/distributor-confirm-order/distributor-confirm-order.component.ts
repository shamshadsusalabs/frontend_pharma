...
@Component({
  selector: 'app-distributor-confirm-order',
  standalone: true,
  imports: [ MatTableModule,
    ...
    MatButtonModule,
    MatIconModule,],
  templateUrl: './distributor-confirm-order.component.html',
  styleUrl: './distributor-confirm-order.component.css'
})
export class DistributorConfirmOrderComponent {
