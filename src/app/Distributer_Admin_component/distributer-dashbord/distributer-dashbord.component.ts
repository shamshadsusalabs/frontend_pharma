...
@Component({
  selector: 'app-distributer-dashbord',
  standalone: true,
...
RouterOutlet,
    ...
    MatIconModule,],
  templateUrl: './distributer-dashbord.component.html',
  styleUrl: './distributer-dashbord.component.css'
})
export class DistributerDashbordComponent {
