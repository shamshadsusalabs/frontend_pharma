...
@Component({
  ...
  templateUrl: './order-brand.component.html',
  styleUrl: './order-brand.component.css'
})
export class OrderBrandComponent {
  ...
  loadDistributors(): void {
    this.discountService.getAllBrand().subscribe({
      next: (data) => {
