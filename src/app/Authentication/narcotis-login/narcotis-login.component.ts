...
import { NarcotisUserService } from '../../_Service/narcotis-user.service'; // Ensure correct import

@Component({
  selector: 'app-narcotis-login',
  standalone: true,
  imports: [
    MatButtonModule,
    MatInputModule,
  ...
  templateUrl: './narcotis-login.component.html',
  styleUrls: ['./narcotis-login.component.css']
})
export class NarcotisLoginComponent {
  loginForm: FormGroup;
  hidePassword = true; // Control for password visibility

  constructor(
    private fb: FormBuilder,
    private narcotisUserService: NarcotisUserService,  // Inject the service
