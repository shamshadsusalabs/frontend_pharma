...
@Component({
  selector: 'app-all-storeuser-list',
  standalone: true,
  imports: [  MatTableModule,
    MatPaginatorModule,
    MatSortModule,
    MatInputModule,],
  templateUrl: './all-storeuser-list.component.html',
  styleUrl: './all-storeuser-list.component.css'
})
export class AllStoreuserListComponent {
  ...
  ngOnInit(): void {
    this.userProfileService.getStoreProfiles().subscribe(data => {
