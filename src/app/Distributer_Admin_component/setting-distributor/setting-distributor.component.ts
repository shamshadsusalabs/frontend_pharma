...
@Component({
  selector: 'app-setting-distributor',
  standalone: true,
  imports: [CommonModule,FormsModule,   ReactiveFormsModule,
    ...
    MatOption,
    MatSelectModule],
  templateUrl: './setting-distributor.component.html',
  styleUrl: './setting-distributor.component.css'
})
export class SettingDistributorComponent {
  userData: any = null;
